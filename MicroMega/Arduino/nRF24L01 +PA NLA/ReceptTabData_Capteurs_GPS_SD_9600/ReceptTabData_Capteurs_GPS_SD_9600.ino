...
void loop() {
  ...
  if (radio.available()) {
    ...
    delay(2);
    radio.read(&TrameGGA, sizeof(TrameGGA));                        //Charge le tableau dans Tab
    delay(2);


    Serial.print('G'); //=========================== Label GPS 

//    Serial.print("GPS Trame. : ");   
    for (int k = 0; k < sizeof(TrameGGA); k++){
      Serial.print(TrameGGA[k]); 
    }
    
      Serial.println('T'); //=========================== Label Temperature
      
//    Serial.print("Temperature : ");
    Serial.println(Tab[0]);

    Serial.println('H'); //=========================== Label Humidité
