...
void loop() {
  ...
  if (radio.available()) {
    ...
    int LongLingne = (size_uint16_t(data_out_CH0) + size_uint16_t(data_out_CH1) + size_uint16_t(data_out_CH2) + size_uint16_t(data_out_CH3) + size_uint16_t(data_out_CH4)
                      + size_uint16_t(data_out_CH5) + size_uint16_t(data_out_CH6) + size_uint16_t(data_out_CH7) + size_uint16_t(data_out_CH8) + strlen(Temp) 
                      + strlen(Hum) + strlen(Pres) + strlen(Alt) + sizeof(UTC) + sizeof(Longitude) + sizeof(OrientationNS) + sizeof(Latitude) + sizeof(OrientationOE) 
                      + sizeof(AltitudeGPS) + 20);    //+ size_uint16_t(data_out_CH9)
