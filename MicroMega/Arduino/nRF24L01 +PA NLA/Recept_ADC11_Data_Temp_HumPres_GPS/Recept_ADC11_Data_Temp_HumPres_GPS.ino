...
void loop() {
  ...
  if (radio.available()) {
    ...
    delay(110);
    radio.read(&data_out_CH10, sizeof(data_out_CH10));
    delay(110);
    ...
    int LongLingne = (size_uint16_t(data_out_CH0) + size_uint16_t(data_out_CH1) + size_uint16_t(data_out_CH2) + size_uint16_t(data_out_CH3) + size_uint16_t(data_out_CH4)
                      ...
                      + size_uint16_t(data_out_CH10)+ strlen(Temp) + strlen(Hum) + strlen(Pres) + strlen(Alt) + sizeof(UTC) + sizeof(Longitude) + sizeof(OrientationNS) 
                      + sizeof(Latitude) + sizeof(OrientationOE) + sizeof(AltitudeGPS) + 20);
                      
    int padding = 125 - LongLingne;
